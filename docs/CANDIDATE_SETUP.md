...
3. **Check the database**: The PostgreSQL database should be running
   ...
   - If needed, you can populate with sample data: `docker-compose exec web python manage.py seed_data` (or `python manage.py seed_data` if using DevContainers/Codespaces)
