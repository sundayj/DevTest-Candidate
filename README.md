...
1. Start with the **[Candidate Quick Start](docs/candidate/quick-start.md)** for the minimal steps.
2. For more detail, see the **[Candidate Setup Guide](docs/CANDIDATE_SETUP.md)**.
...
4. **Submit Your Work:**
   ...
   - Create a **Pull Request** in your private repository and add [sundayj](https://github.com/sundayj) as a reviewer.
5. **Timeline:** You have **one week** from your initial interview to submit your completed task or tasks. After we review your final pull request(s), we'll schedule a follow-up interview to discuss your approach.
